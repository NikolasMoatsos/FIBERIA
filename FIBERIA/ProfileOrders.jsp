                ...
                <div class="modal-content">
                    ...
                    <div class="card-body text-center">
                        <div class=" text-center">
                            ...
                            <div class="text-center mt-4 buttons3"> 
                                <button class="btn btn-secondary send px-5" style="color: black;border-color:#ee8175;" data-dismiss="modal">Send review </button> 
