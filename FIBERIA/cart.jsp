...
<div class="container cont " style=" margin-top: 100px; ">
   <div class="card shopping-cart">
            <div class="card-header  " style="background-color: #ed8074; color: white;" >
                ...
                if(products.size() >0){
                  %>
                <div id="shopping" class="buttons pull-right " style=" margin-top: 5px;" >
                  <a href="collection.jsp"><button >Continue shopping</button></a>
                </div>
                <div id="back" class="buttons pull-right " style=" margin-top: 5px;" >
                  <a href="collection.jsp"><button style="width: 100px;">Back</button></a>
                </div>
                <%
                 }
                 %>
            ...
            <div class="card-body">
                    ...
                    if(products.size() >0){
                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-4 col-6 col-sm-3 text-sm-center col-md-3 text-md-right row">
                              <div class="col-8 col-sm-6 col-md-6 text-md-center" >
                                  <h5 style="padding-top: 38px"><strong><%= prod.getPrice()%>€</strong></h5>
                              </div>
                              
                              <div class="col-3 col-sm-4 col-md-3 text-right" style="padding-top: 30PX;">
                    ...
                    <div class="card-footer" style="background-color: #ed807425;">
                        ...
                        <div   style="margin: 10px; ">
                          <div class="buttons pull-right" >
                            <a href="order.jsp"><button id="checkout">Checkout</button></a>
                          </div>
                            
                            <div id="total" class="pull-right col-6 col-sm-3 col-md-3" style="margin: 5px; margin-right:15px; text-align: right; font-size: large;">
