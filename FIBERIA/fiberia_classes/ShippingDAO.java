...
public class ShippingDAO {
    ...
    public Shipping findshipping(Integer orderId) throws Exception{
        DB db = new DB();
        Connection con = null;
        PreparedStatement stmt = null;
        ResultSet rs= null ;
        String sql = "SELECT * FROM shipping_form WHERE orderId=?;";
        try {
			...
			Shipping shipping=new Shipping(rs.getString("firstname"),rs.getString("lastname"),rs.getString("phone"),rs.getString("shippingAddress"),rs.getString("zipCode"),rs.getString("email"),rs.getInt("orderId"));
			rs.close();
			stmt.close();
			db.close();
			return shipping;
