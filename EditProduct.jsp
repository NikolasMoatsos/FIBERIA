    ...
    <div class="container cont" style="color:black">
      ...
      <div class="row">
          ...
          <div class="form-row" style="margin-top: 10px;">
            <div class="text-center ">
              ...
              <div class="custom-file form-row">
                ...
                <label class="custom-file-label" for="customFile"  style="text-align: left;">Choose an Image</label>
                <br>
                <br>
          ...
          <div class="col-md-9 personal-info">
            ...
            <h3 style="margin-top: 10px;margin-bottom: 15px;">Product Details</h3>
            ...
            <form class="form-horizontal" action="editProductController.jsp" role="form" method="POST">
              ...
              <div class="form-group">
                <label class="col-md-3 control-label labels">Brand</label>
                <div class="col-md-8">
                  <input class="form-control" value="<%=prod.getBrand()%>" name="brand">
                </div>
              </div>
              <div class="form-group form-row"  >
                <div class="form-group col-md-8 pull-left" style="text-align: center;">
              ...
              <div class="form-group buttons">
                <button class="btn btn-success primary profile-button" type="submit" style="color:black;border-color: #ee8175;margin-left: 190px;">Save Changes</button>
              </div>
            </form>
          </div>
      </div>
