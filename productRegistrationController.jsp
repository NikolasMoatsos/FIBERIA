...
if (purchaseDate.equals("")){
    ...
    try{
        ...
        mess +="<dt>Enter the purchase date.</dt>";
    }
}
mess += "</dl>";

String strdate = "";
if (priced || productName.equals("") || brand.equals("") || description.equals("") || packaged.equals("") || purchaseDate.equals("") || gender.equals("---Select Gender---") || category.equals("---Select Category---") || size.equals("---Select Size---") || color.equals("---Select Color---")){
...
<%
    ...
    session.setAttribute("productobj", product1);
%>
