            ...
            <div class="col-md-3 border-right">
                <form action="editProfileController.jsp" method="POST">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5" style="margin-top: 105px;">
                        ...
                        <div class="mt-4 text-center buttons2"><button class="btn  primary profile-button" type="button" style="color:black;border-color: #ee8175;">Apply Image</button></div>
                    </div>
                </form>
            </div>
            <div class="col-md-5">
                ...
                <div class="col-md-5 border-right">
                    <div class="p-3 py-5" style="color:#3c096c;">
                        ...
                        <div class="row mt-2" style="color: black;">
                            <div class="col-md-6"><label class="labels" style="font-size: small;">Name</label><input type="text" name="name" class="form-control" value="<%= user.getName() %>"  ></div>
                            <div class="col-md-6"><label class="labels" style="font-size: small;">Surname</label><input type="text" name="surname" class="form-control" value="<%= user.getSurname() %>"></div>
                        </div>
                        <div class="row mt-3 " style="color:black;">
                            ...
                            <div class="col-md-12"><label class="labels" style="font-size: small;">Email</label><input type="email" name="email" class="form-control" style="margin-bottom: 15px;" value="<%= user.getEmail() %>"></div>
                        </div>
                    </div>
                </div>
